...
(function($)
{
	...
	var p = TextExtTags.prototype,
		 ...
		 *
		 * @name html.tags
		 * @default '<div class="text-tag"><div class="text-button"><span class="text-label"/><i class="fa fa-times text-remove"></i></div></div>'
		 * @author agorbatchev
		 * @date 2011/08/19
		...
		DEFAULT_OPTS = {
			...
			html : {
				...
				tag  : '<div class="text-tag"><div class="text-button"><span class="text-label"/><i class="fa fa-times text-remove"></i></div></div>'
			}
		}
		;
